        ...
        <div className="w-full max-w-md space-y-8 md:space-y-12 py-6 md:py-12">
          <div className="text-center space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-[10px] font-bold text-neutral-400 tracking-[0.2em] uppercase">Current Email Address</p>
              <h2 className="text-xl font-bold text-neutral-900">{user?.email || 'Unavailable'}</h2>
            </div>
          </div>
          ...
          <div className="space-y-6 pt-4">
            <Button
              ...
              disabled={isSubmitting || !newEmail.trim() || !confirmEmail.trim()}
